...
<div className='container4'>
              <h2 style={{ marginBottom: '-12%', color: 'white' }}><b>Payment Subscription</b></h2>
              {/* {alert} */}
              {showPopup && (
                <div className="popup1" role="dialog" aria-modal="true" aria-labelledby="dialog1Title">
                  <button id="close" onClick={handleClose} aria-label="close popup">&times;</button>
                  <h2 id="dialog1Title" style={{ fontSize:'17px',fontWeight:'600',}}><b>Activation Fee + First Month </b> </h2>
                  
                  <p style={{ fontSize:'25px',fontWeight:'600',}}>R749</p>
                  <button onClick={confirmSubscription2} style={{ backgroundColor:'#E2520F', color: 'white',borderRadius: '60px',padding:'9px',fontSize:'15px',fontWeight:'600',border:' 2px solid #E2520F' }}>Pay Now</button>
                </div>
              )}
              {showPopup2 && (
                <div className="popup" role="dialog" aria-modal="true" aria-labelledby="dialog2Title">
                  <button id="close" onClick={handleClose2} aria-label="close popup">&times;</button>
                  <h2 id="dialog2Title" style={{ fontSize:'17px',fontWeight:'600',}}><b>Activation Fee Payment Only</b></h2>
                  
                  <p style={{ fontSize:'25px',fontWeight:'600',}}>R399</p>
                  <button onClick={confirmSubscription2} style={{ backgroundColor:'#E2520F', color: 'white',borderRadius: '50px',padding:'9px',fontSize:'15px',fontWeight:'600', border:' 2px solid #E2520F'  }}>Pay Now</button>
                </div> 
              )}
              <br/><br/><br/><br/>
               <h5 style={{paddingRight:'-19%',paddingTop:'250px',color:'white',fontSize:'12px',}}>* Your monthly payment will be due on completion of installation</h5>
            </div>
    </main>
  );
};
