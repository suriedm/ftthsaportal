...
const OTPModal = () => {
 ...
 <div id="login" className="modal fade" role="dialog" style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "fixed",width:"360%",marginTop:"9%",}}>
  <div className="modal-dialog1">
    <div className="modal-content1" style={{ borderRadius: "29px", height: "auto", width: "270px" }}>
      <div className="modal-body1">
        ...
        <br/>
        <div style={{ color: "white", textAlign: "center",fontSize:"18px",fontWeight:"600" }}>
