...
import confirmOTP from '../components/OTPModal';
import  Profile  from "@/profile/page";
import { FaEye, FaEyeSlash } from "react-icons/fa";
import SuccessPayment from "@/SuccessPayment/page";
        ...
        <div className="modal-dialog1">
          <div className="modal-content1" style={{ position: "relative" }}>
            ...
            <div className="modal-body1">
              <h2 style={{ marginTop: "-14%", color: "white", fontSize: "27px" }}>
                Login
              </h2>
              <br />
      ...
      >
        ...
        <div style={{ display: "flex", width: "70px", alignItems: "center" }}>
          ...
          >
            ...
            {profile ? (
              <h6 style={{ marginLeft: "-48px",fontSize:"16px",alignContent:"center"}}>{profile.first_name}</h6>
            ) : null}
